...
public class SalaAdvinha extends Sala{
    public SalaAdvinha(Component c1, Component c2, String nome, Inimigo ini) {
    ...
    public void selecionarCaminho(Personagem p) {
        ...
        URL imageUrl = ClassLoader.getSystemResource("campoOFC.jpg");
        ...
        while ((getInimigo().getLife()>=0) && (p.getLife()>0)) { // enquanto está ocorrendo a luta
            ...
            if(getInimigo().getLife() <= 0){
                ...
                Object[] itens = { "Caminho 1", "Caminho 2" };
                Object caminho = JOptionPane.showInputDialog(null,
                        "Escolha um item", "Opções",
    ...
    public void lutar(Personagem p) {
        ...
        do {
            inputValue = JOptionPane.showInputDialog("Qual o valor do dano gerado? (1 a 10)");
        ...
        if (num == dano) {
            JOptionPane.showMessageDialog(null, "Acertou, venceu o inimigo");
            System.out.println("Acertou, dessa forma você venceu o inimigo");
            getInimigo().setLife(0);
        } else {
            JOptionPane.showMessageDialog(null, "Errou, enfrente o inimigo");
            System.out.println("Palpite errado, você enfrentará o inimigo");
            getInimigo().getA().setDano(num);
        }
    }
